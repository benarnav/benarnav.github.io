...
<figure style="text-align: center;">
    <img style="max-width: 700px;" src="/assets/img/dream_loss_funcs.png" alt="deepdream loss function comparison" />
...
<figure style="text-align: center;">
    <img style="max-width: 700px;" src="/assets/img/dream_clouds.png" alt="deepdream in the clouds" />
...
<figure style="text-align: center;">
    <img style="max-width: 700px;" src="/assets/img/dream_activations.jpg" alt="deepdream layer activations" />
...
<figure style="text-align: center;">
    <img style="max-width: 700px;" src="/assets/img/dream_container_blind.png" alt="classifying images before and after blinding" />
