...
+ The machine learning model could be improved in various ways depending on stakeholder needs. In a future version I would want to change it to a multiclassificaiton problem with the minimum categories being: injured, severely injured, and killed. New York's Department of Transportation has a program for reporting [more granular](https://www.nyc.gov/html/dot/downloads/pdf/sirta-report-q2-2023.pdf) injury statistics, but it only began reporting in 2022.
